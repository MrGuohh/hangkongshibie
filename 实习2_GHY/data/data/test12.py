...
# 开发时间:2023/3/11 0:58
import pandas as pd
test_data = pd.read_csv('D:/实习2/data/data/test.csv',low_memory=False)
selected_data = test_data[['seg_route_to', 'seg_flight', 'seg_cabin', 'pax_fcny', 'emd_lable',
       ...
       'pit_avg_interval_y2', 'pit_add_chnl_y2', 'pit_add_chnl_y3','emd_lable2']]
selected_data.to_csv('test3.csv', index=False)